...
#'
#' pr_cross_seq(block_df, block_ref_df, sequence_1, start_time, end_time)
#' pr_cross_seq(block_df, block_ref_df, sequence_2, start_time, end_time, keep_NA = T, unit = 's')
#'
#'
pr_cross_seq <- function(block_df,
                         block_ref_df,
                         sequence,
                         start_time,
                         end_time,
