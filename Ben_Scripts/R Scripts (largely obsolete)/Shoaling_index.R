...
# D. Function n°3 - obtain accompanied reads for all individuals at all antennas
  ...
  reads <- function(antenna){
    ...
    # I run function n°3 end up with a list of data frames, where each data frame contains all the
    # accompanied reads for an individual.
    df2 <- reads(bottom_list_df_ant)
...
# E. I obtain the number of accompanied reading series and duration for all individuals.
  ...
  # Here, I will use a function written in the Duration_and_reading_series script to obtain, from the list of reads,
