...
```{r, message = FALSE}
    ...
    ggplot(data = EB_Lat_final, aes(x = Treatment_seq, y = Expl_index, fill = time_of_day)) + 
      ...
      labs(y = "Exploration tendency", x =" ") +
      scale_y_continuous(expand = c(0, 0), limits = c(0,NA))



    ggplot(data = EB_Lat_final, aes(x = Treatment_seq, y = Expl_index)) + 
