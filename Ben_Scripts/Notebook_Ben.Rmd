...
- Input = A dataframe containing the antenna changes for one individual
...
Next, I can apply the function above to all individuals
...
# I add a new column with the time to cross the box since the start of the test
# For the morning
  EB_Lat_2_morning <- mutate(subset(df3, time_of_day == "Morning"), 
                           time_since_start = difftime(Ant2, start_morning, units='m'))
# For the afternoon
  EB_Lat_2_afternoon <- mutate(subset(df3, time_of_day == "Afternoon"), 
