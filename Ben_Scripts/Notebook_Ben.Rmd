...
ggplot(data = indices, aes(latency_enter)) +
    geom_histogram(aes(),
                   bins = 20,
                   fill="#6f7b96",
                   colour = "white") +
...
```{r, message = FALSE}
    ...
    ggplot(data = indices, aes(x = Treatment_seq, y = latency_cross, fill = time_of_day)) + 
    ...
    ggplot(data = indices, aes(x = Treatment_seq, y = latency_cross)) + 
