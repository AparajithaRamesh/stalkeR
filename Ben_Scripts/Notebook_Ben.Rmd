...
Idea of the function is to obtain, for each individual:

- Latency to enter the box (_i.e._ reach antenna 2 or 3)
- Latency to fully cross the box (_i.e._ reach antenna 2 *and* 3) without leaving the box
- Total time spent in the box (_i.e._ time spent between read at antenna 2 or 3 until leaving the box at antenna 1 or 4)
