...
This notebook contains chunks of R script computing EB_output for five different behaviours:
...
There is no specific behavioural test for the last index. Instead, the shoaling metric is retrieved from the data collected in the four other tests. This notebook is so far written to compute the individuals behavioural EB_output for one week of treatment, from the four weekly data sets.
...
week1_df <- data.frame(EB_output[c("id", "Treatment_seq", "Pond", "latency_entrance")],
